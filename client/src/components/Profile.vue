            ...
            <div class="grid">
                ...
                <div>
                    <ul>
                        ...
                        <li v-if="profileData.segments[0].stats.season6Wins">
                            <h4>Season 2 Wins</h4>
                            <p>
                                {{profileData.segments[0].stats.season6Wins.displayValue}}
                                <span>({{profileData.segments[0].stats.season6Wins.percentile}}%)</span>
                            </p>
                        </li>
